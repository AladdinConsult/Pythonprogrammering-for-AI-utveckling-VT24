...
def create_gan_model(alpha=2.0, descrimiator_lr=0.0001, generator_lr=0.0001, epochs=1000, save_model=False, model_path='./19 Feb/models/gan_model.keras'):
    ...
    real_data = load_real_data('./19 Feb/data/random_numbers.txt')
